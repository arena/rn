        ...
        <>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2 mt-1">
                                                ...
                                                <span className="text-xs text-gray-600">
                                                    {skill.steps.length} {contentData.practice.steps_text}
                                                </span>
                                    ...
                                    <div className="p-4 space-y-4">
                                                        ...
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                <p className={`text-sm leading-relaxed ${
                                                                    ...
                                                                    {isCritical && (
                                                                        <span className="ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                                            {contentData.practice.critical_text}
                                                                        </span>
                                                                    )}
                                                                </p>
                                                                ...
                                                                <div className="flex gap-2 mt-2">
                                                                    ...
                                                                    >
                                                                        <CheckIcon />
                                                                        {contentData.practice.done_text}
                                                                    </button>
                                                                    <button
                                                                    ...
                                                                    >
                                                                        <MinusIcon />
                                                                        {contentData.practice.skip_text}
                                                                    </button>
                                                                    <button
                                                                    ...
                                                                    >
                                                                        <XIcon />
                                                                        {contentData.practice.miss_text}
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        {allStepsEvaluated && !isCompleted && (
                                            <div className="pt-2 border-t border-gray-200">
                                                ...
                                                >
                                                    <CheckCircleIcon />
                                                    {contentData.practice.complete_skill_text}
                                                </button>
                                            </div>
                                        )}
                                    </div>
            ...
            {allSkillsCompleted && (
                <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200 space-y-4">
                    <div className="text-center">
                        <div className="text-green-800 font-bold text-xl mb-2">{contentData.practice.session_complete}</div>
                        <p className="text-gray-700">{contentData.practice.session_complete_description}</p>
                    </div>
                    ...
                    <div className="text-center space-y-2">
                        ...
                        >
                            {contentData.practice.share_results}
                        </button>
                        <div>
                            <button
                            ...
                            >
                                {contentData.practice.try_again}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-6 text-center space-y-2">
                ...
                <div>
                    ...
                    >
                        <RotateIcon />
                        {contentData.practice.reset_timer}
                    </button>
                </div>
            </div>
        </>
